...
cell_gene_comb <- function(sce, gene1, gene2){
  length(which(counts(sce)[gene1, ] > 2 & counts(sce)[gene2,] > 2))
}

print("Number cells with >2 Pdpn AND Pecam1 in both experiments:")
cell_gene_comb(sce, "Pdpn", "Pecam1")

print("Number cells with >2 Pdpn AND Pecam1 in old experiment:")
cell_gene_comb(sce[,sce$experiment %in% "old"], "Pdpn", "Pecam1")

print("Number cells with >2 Pdpn AND Pecam1 in new experiment:")
cell_gene_comb(sce[,sce$experiment %in% "new"], "Pdpn", "Pecam1")
